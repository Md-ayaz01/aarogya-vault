...
class AppTheme {
  // Helper to swap GoogleFonts for standard system fonts during tests to prevent runtime HTTP exceptions
  ...
  static ThemeData get lightTheme => ThemeData(
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
        ...
        textStyle: TextStyle(fontSize: 16, fontWeight: FontWeight.w600), // Standard TextStyle is fine for buttons as textTheme overrides it anyway
        elevation: 0,
      ),
    ),
  ...
  static TextTheme _buildTextTheme(Brightness brightness) {
    ...
    return TextTheme(
      displayLarge:  _getTextStyle(fontSize: 36, fontWeight: FontWeight.w800, letterSpacing: -1.0, color: textColor),
      displayMedium: _getTextStyle(fontSize: 28, fontWeight: FontWeight.w700, letterSpacing: -0.5, color: textColor),
      headlineLarge: _getTextStyle(fontSize: 24, fontWeight: FontWeight.w700, color: textColor),
      headlineMedium: _getTextStyle(fontSize: 20, fontWeight: FontWeight.w600, color: textColor),
      headlineSmall: _getTextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: textColor),
      titleLarge:    _getTextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: textColor),
      titleMedium:   _getTextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: textColor),
      titleSmall:    _getTextStyle(fontSize: 12, fontWeight: FontWeight.w500, color: subtitleColor),
      bodyLarge:     _getTextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: textColor),
      bodyMedium:    _getTextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: textColor),
      bodySmall:     _getTextStyle(fontSize: 12, fontWeight: FontWeight.w400, color: subtitleColor),
      labelLarge:    _getTextStyle(fontSize: 12, fontWeight: FontWeight.w700, letterSpacing: 0.3, color: textColor),
      labelMedium:   _getTextStyle(fontSize: 11, fontWeight: FontWeight.w600, color: subtitleColor),
      labelSmall:    _getTextStyle(fontSize: 10, fontWeight: FontWeight.w700, letterSpacing: 1.2, color: subtitleColor),
    );
  }
